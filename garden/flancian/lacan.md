...
- A [[person]]. [[Writer]].
- El signo
  - Lo deseado y lo necesario.
  - Lo deseado es un significado (en el sentido de Saussure) que no es accessible.
  - Lo necesario, que es no es reprimido, es el significante.
- El nivel de lo simbólico es el nivel del lenguaje. Es lo expresable.
    - Lacan no cree que se pueda traer a lo real al nivel de lo simbólico; lo inconsciente es inalcanzable.
